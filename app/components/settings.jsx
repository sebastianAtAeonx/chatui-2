            ...
            <List>
              <ListItem title={Locale.Settings.Sync.Config.WebDav.Endpoint}>
                <input
                  ...
                  onChange={e => {
                    syncStore.update(
                      config => (config.webdav.endpoint = e.currentTarget.value)
                    )
                  }}
                ></input>
              </ListItem>
              ...
              <ListItem title={Locale.Settings.Sync.Config.WebDav.UserName}>
                <input
                  ...
                  onChange={e => {
                    syncStore.update(
                      config => (config.webdav.username = e.currentTarget.value)
                    )
                  }}
                ></input>
              </ListItem>
              <ListItem title={Locale.Settings.Sync.Config.WebDav.Password}>
                <PasswordInput
                  ...
                  onChange={e => {
                    syncStore.update(
                      config => (config.webdav.password = e.currentTarget.value)
                    )
                  }}
                ></PasswordInput>
              </ListItem>
          ...
          <List>
            <ListItem title={Locale.Settings.Sync.Config.UpStash.Endpoint}>
              <input
                ...
                onChange={e => {
                  syncStore.update(
                    config => (config.upstash.endpoint = e.currentTarget.value)
                  )
                }}
              ></input>
            </ListItem>
            ...
            <ListItem title={Locale.Settings.Sync.Config.UpStash.UserName}>
              <input
                ...
                onChange={e => {
                  syncStore.update(
                    config => (config.upstash.username = e.currentTarget.value)
                  )
                }}
              ></input>
            </ListItem>
                ...
                <>
                  ...
                  >
                    <Select
                      ...
                      onChange={e => {
                        accessStore.update(
                          access => (access.provider = e.target.value)
                        )
                      }}
                    >
